  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <label>
          Person ID:
          <input type="number" name="personId" value={personId} onChange={(e) => setPersonId(e.target.value)}/>
        </label>
        <label>
          Address ID:
          <input type="number" name="addressId" value={addressId} onChange={(e) => setAddressId(e.target.value)}/>
        </label>
